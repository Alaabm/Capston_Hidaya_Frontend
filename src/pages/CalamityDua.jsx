        ...
        <div className="card-content-dua">
          <div className="sleep-dua">
            <p style={{ fontSize: "17pt" }}>
              إِنَّا لِلهِ وَإِنَّا إِلَيْهِ رَاجِعُونَ ، اللَّهُمَّ أْجُرْنِي
              فِي مُصِيبَتِي ، وَاخْلُفْ لِي خَيْرًا مِنْهَا
            </p>
            <br />
            <InfoCollapse buttonText="Transliteration">
              <p>
                innaa lillaahi wa innaa ilayhi raaji‛oon, allaahumma’ jurnee fee
                muṣeebatee, wakhluf lee khayran minhaa
              </p>
            </InfoCollapse>
            <br />
