      ...
      <div>
        ...
        <div className="card-dua">
            <div className="card-content-dua">
                <div className="thankful">
                          <p>
                            اَللّٰهُمَّ مَا أَمْسَىٰ بِيْ مِنْ نِّعْمَةٍ أَوْ بِأَحَدٍ مِّنْ
                          ...
                          <div className="morning-collapse">
                            <InfoCollapse buttonText="Transliteration">
                              <p>
                                Allāhumma mā amsā bī min niʿmatin aw bi-aḥadin min khalqik,
                            ...
                            <InfoCollapse buttonText="Translation">
                              <p>
                                ...
                                received in the evening, are from You Alone. You have no partner.
        ...
        <div className="card-dua">
            <div className="card-content-dua">
                <div className="tawhid">
                          <p>
                            {" "}
                            أَمْسَيْنَا عَلَىٰ فِطْرَةِ الْإِسْلَامِ ، وَعَلَىٰ كَلِمَةِ
                          ...
                          <div className="morning-collapse">
                            <InfoCollapse buttonText="Transliteration">
                              <p>
                                Amsaynā ʿalā fiṭrati-l-islām, wa ʿalā kalimati-l-ikhlāṣ, wa ʿalā
                            ...
                            <InfoCollapse buttonText="Translation">
                              <p>
                                ...
                                and he was not of the polytheists. (Nasā’ī)
                              </p>
                            </InfoCollapse>
                          </div>
                        </div>
        ...
        <div className="card-dua">
            <div className="card-content-dua">
                <div className="praise">
                          <p>
                            أَمْسَيْتُ أُثْنِيْ عَلَيْكَ حَمْدًا ، وَأَشْهَدُ أَنْ لَّا إِلٰهَ
                            إِلَّا اللّٰهُ
                          </p>
                          <div className="morning-collapse">
                            <InfoCollapse buttonText="Transliteration">
                            ...
                            <InfoCollapse buttonText="Translation">
                              <p>
                                I have entered the evening praising You, and I bear witness that
        ...
        <div className="card-dua">
            <div className="card-content-dua">
              <div className="good">
                        <p>
                          أَمْسَيْنَا وَأَمْسَى الْمُلْكُ لِلّٰهِ وَالْحَمْدُ لِلّٰهِ ، لَا
                          ...
                          أَسْأَلُكَ خَيْرَ مَا فِيْ هٰذِهِ اللَّيْلَةِ وَخَيْرَ مَا بَعْدَهَا ،
                          وَأَعُوْذُ بِكَ مِنْ شَرِّ مَا فِيْ هٰذِهِ اللَّيْلَةِ وَشَرِّ مَا
                          بَعْدَهَا ، رَبِّ أَعُوْذُ بِكَ مِنَ الْكَسَلِ وَسُوْءِ الْكِبَرِ ،
                          رَبِّ أَعُوْذُ بِكَ مِنْ عَذَابٍ فِي النَّارِ وَعَذَابٍ فِي الْقَبْرِ
                        </p>
                        <div className="morning-collapse">
                          <InfoCollapse buttonText="Transliteration">
                            <p>
                              Amsaynā wa amsa-l-mulku li-llāh, wa-l-ḥamdu li-llāh, lā ilāha
                              ...
                              hādhihi-l-laylati wa khayra mā baʿdah, wa aʿūdhu bika min sharri
                              mā fī hādhihi-l-laylati wa sharri mā baʿdah. Rabbi aʿūdhu bika
                              mina-l-kasali wa sū’i-l-kibar, Rabbi aʿūdhu bika min ʿadhābin
                              fi-n-nāri wa ʿadhābin fi-l-qabr.
                            </p>
                          </InfoCollapse>
                          <br />
                          <InfoCollapse buttonText="Translation">
                            <p>
                              We have entered the evening and at this very time the whole
                              ...
                              You for the good that is in this night and the good that follows
                              it, and I seek Your protection from the evil that is in this night
                              and from the evil that follows it. My Lord, I seek Your protection
        ...
        <div className="card-dua">
            <div className="card-content-dua">
                <div className="bless">
                          <p>
                            أَمْسَيْنَا وَأَمْسَى الْمُلْكُ لِلّٰهِ رَبِّ الْعَالَمِيْنَ ،
                            اَللّٰهُمَّ إِنِّيْ أَسْأَلُكَ خَيْرَ هـٰذِهِ اللَّيْلَةِ ، فَتْحَهَا
                          ...
                          <div className="morning-collapse">
                            <InfoCollapse buttonText="Transliteration">
                              <p>
                                Amsaynā wa amsa-l-mulku li-llāhi Rabbi-l-ʿālamīn, Allāhumma innī
                                as’aluka khayra hādhihi-l-laylah, fatḥahā wa naṣrahā wa nūrahā wa
                                barakatahā wa hudāhā, wa aʿūdhu bika min sharri mā fīhā wa sharri
                                mā baʿdahā.
                              </p>
                            </InfoCollapse>
                            <br />
                            <InfoCollapse buttonText="Translation">
                              <p>
                                ...
                                for the goodness of this day/night: its victory, its help, its
                                light, and its blessings and guidance. I seek Your protection from
                                the evil that is in it and from the evil that follows it.
                              </p>
                            </InfoCollapse>
                          </div>
                        </div>
        ...
        <div className="card-dua">
            <div className="card-content-dua">
                <div className="freed">
                          <p>
                            اَاَللّٰهُمَّ إِنِّيْ أَمْسَيْتُ أُشْهِدُكَ وَأُشْهِدُ حَمَلَةَ
                          ...
                          <div className="morning-collapse">
                            <InfoCollapse buttonText="Transliteration">
                              <p>
                                Allāhumma innī amsaytu ush-hiduka, wa ush-hidu ḥamlata ʿarshika,
                                wa malā’ikatika, wa jamī’a khalqika, annaka Anta-llāhu lā ilāha
                                illā Anta waḥdak, lā sharīka lak, wa an-na Muḥammadan ʿabduka wa
                                rasūluk.
                              </p>
                            </InfoCollapse>
                            <br />
                            <InfoCollapse buttonText="Translation">
                              <p>
                                O Allah, I have entered the evening, and I call upon You, the
        ...
        <div className="card-dua">
            <div className="card-content-dua">
                <div className="evening">
                          <p>
                            اَللّٰهُمَّ بِكَ أَمْسَيْنَا وَبِكَ أَصْبَحْنَا وَبِكَ نَحْيَا وَبِكَ
                            نَمُوْتُ وَإِلَيْكَ الْمَصِيْرُ
                          </p>
                          <div className="morning-collapse">
                            <InfoCollapse buttonText="Transliteration">
                              <p>
                                Allāhumma bika amsaynā wa bika aṣbaḥnā wa bika naḥyā wa bika
                                namūtu wa ilayka-l-maṣīr.
                              </p>
                            </InfoCollapse>
                            <br />
                            <InfoCollapse buttonText="Translation">
                              <p>
                                O Allah, by You we have entered the evening and by You we enter
                                upon the morning. By You, we live and we die, and to You is the
                                resurrection/return.
                              </p>
                            </InfoCollapse>
                          </div>
